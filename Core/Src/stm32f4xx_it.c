...
/* USER CODE BEGIN EV */
extern volatile uint8_t state_touch;

extern volatile int32_t x_goal, y_goal;
extern volatile int32_t err_x, err_y, err_alpha, err_beta;
extern volatile int32_t pos_control_signal_x, pos_control_signal_y, ang_control_signal_alpha, ang_control_signal_beta;
extern volatile int32_t position_x, position_y;
extern volatile float int_pos_x, int_pos_y, int_ang_alpha, int_ang_beta;
...
void TIM1_UP_TIM10_IRQHandler(void)
{
  /* USER CODE BEGIN TIM1_UP_TIM10_IRQn 0 */
	...
	if(state_touch ){
		/*Here, I use two cascaded PID controllers for each axis of the plate.
		 * The first PID is used to compute the position error, while the second PID calculates the tilt angle error.
